...
HD_PWD='C:/Users/sbast/Desktop/PROYECTO01_SEP/Proyecto1/IPCORES_P1/State_Macine_P1/State_Macine_P1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log StateMachine_P1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source StateMachine_P1.tcl -notrace
