...
HD_PWD='C:/Users/sbast/Desktop/P1_2.0/P1/Proy1_SEP/Proy1_SEP.runs/design_1_Sequence_Memory_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Sequence_Memory_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Sequence_Memory_0_1.tcl
